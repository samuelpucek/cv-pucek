...
\begin{rSection}{Experience}
	...
	\begin{rSubsection}{Draslovka}{Jul 2025 - Present}{Lead Data Scientist}{Prague, Czech Republic}
        \item Technical lead of the data science team: solution design, code review, and mentoring
        \item Built the data science team, hiring and onboarding 4 new data scientists
        \item Designed and built from scratch the end-to-end ML pipeline, a SaaS product for gold mines
	\end{rSubsection}

	%------------------------------------------------

	\begin{rSubsection}{Draslovka}{Nov 2023 - Jun 2025}{Senior Data Scientist}{Prague, Czech Republic}
        \item Improved performance of supervised and unsupervised ML models through feature selection and engineering
        \item Analyzed 300+ plant signals, including assay results and derived features
        \item Gained domain knowledge in the Cyanide-in-Leach (CIL) gold extraction process, including grinding, flotation, and leaching circuits
        \item Built grinding and leaching simulations following first-principles described in research papers
	\end{rSubsection}

	%------------------------------------------------

	\begin{rSubsection}{Gen (acquired Avast)}{Feb 2023 - Oct 2023}{Principal Data Scientist}{Prague, Czech Republic}
...
\begin{rSection}{Individual interests}
	Running (marathon 3:00:03, half-marathon 1:23:51), hiking, cycling, flying (PPL holder)
	\end{rSection}
